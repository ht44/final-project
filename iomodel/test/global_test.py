...
class TestEachYear(object):
    ...
    def test_direct_req(self, multi_year):
        assert len(multi_year.econ.direct_req) == multi_year.test_derivations.commodity_count
    ...
    def test_market_share(self, multi_year):
        assert len(multi_year.econ.market_share) == multi_year.test_derivations.industry_count
    ...
    def test_tech_coefficient(self, multi_year):
        assert len(multi_year.econ.tech_coefficient) == multi_year.test_derivations.commodity_count
    ...
    def test_leontief_inverse(self, multi_year):
        assert len(multi_year.econ.leontief_inverse) == multi_year.test_derivations.commodity_count
        assert len(multi_year.econ.leontief_inverse[0]) == multi_year.test_derivations.commodity_count
    ...
    def test_total_requirements(self, multi_year):
        assert len(multi_year.econ.total_requirements) == multi_year.test_derivations.commodity_count
    ...
    def test_unit_requirements(self, multi_year):
        assert len(multi_year.econ.unit_requirements) == multi_year.test_derivations.commodity_count
    ...
    def test_unit_price(self, multi_year):
        assert len(multi_year.econ.unit_price) == multi_year.test_derivations.commodity_count
        np.testing.assert_almost_equal(multi_year.econ.unit_price,
                                       np.ones(multi_year.test_derivations.commodity_count),
                                       decimal=1)
    ...
    def test_tax_coefficient(self, multi_year):
        assert len(multi_year.econ.tax_coefficient) == multi_year.test_derivations.commodity_count
    ...
    def test_rel_unit_price(self, multi_year):
        ...
        expected = np.ones(multi_year.test_derivations.commodity_count)
        assert len(rel_unit_price) == multi_year.test_derivations.commodity_count
    ...
    def test_rel_total_requirements(self, multi_year):
        assert len(multi_year.econ.rel_total_requirements) == multi_year.test_derivations.commodity_count
    ...
    def test_process_args(self, multi_year):
        ...
        vals = [random.random() for j in range(multi_year.test_derivations.commodity_count)]
