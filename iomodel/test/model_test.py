...
class TestYear(object):
    ...
    def test_model_size(self, single_year):
        assert single_year.econ.size == single_year.test_derivations.industry_count

    def test_use_matrix(self, single_year):
        assert len(single_year.econ.use_matrix) == single_year.test_derivations.commodity_count
        assert len(single_year.econ.use_matrix[0]) == single_year.test_derivations.industry_count

    def test_make_matrix(self, single_year):
        assert len(single_year.econ.make_matrix) == single_year.test_derivations.industry_count
        assert len(single_year.econ.make_matrix[0]) == single_year.test_derivations.commodity_count

    def test_industry_vector(self, single_year):
        assert len(single_year.econ.industry_vector) == single_year.test_derivations.industry_count

    def test_commodity_vector(self, single_year):
        assert len(single_year.econ.commodity_vector) == single_year.test_derivations.commodity_count

    def test_value_vector(self, single_year):
        assert len(single_year.econ.value_vector) == single_year.test_derivations.industry_count

    def test_noncomp_vector(self, single_year):
        assert len(single_year.econ.noncomp_vector) == single_year.test_derivations.industry_count

    def test_demand_vector(self, single_year):
        assert len(single_year.econ.demand_vector) == single_year.test_derivations.commodity_count
    ...
    def test_commodity_legend(self, single_year):
        ...
        elif single_year.test_derivations.commodity_count == 73:
            assert single_year.econ.commodity_legend[0] == 'Farms'
        penult_idx = single_year.test_derivations.commodity_count - 2
        last_idx = single_year.test_derivations.commodity_count - 1
    ...
    def test_cxi_null_matrix(self, single_year):
        assert len(single_year.econ.cxi_null_matrix) == single_year.test_derivations.commodity_count
        assert len(single_year.econ.cxi_null_matrix[0]) == single_year.test_derivations.industry_count
        expected = np.zeros((single_year.test_derivations.commodity_count, single_year.test_derivations.industry_count))
    ...
    def test_direct_req(self, single_year):
        assert len(single_year.econ.direct_req) == single_year.test_derivations.commodity_count
    ...
    def test_market_share(self, single_year):
        assert len(single_year.econ.market_share) == single_year.test_derivations.industry_count
    ...
    def test_tech_coefficient(self, single_year):
        assert len(single_year.econ.tech_coefficient) == single_year.test_derivations.commodity_count
    ...
    def test_leontief_inverse(self, single_year):
        assert len(single_year.econ.leontief_inverse) == single_year.test_derivations.commodity_count
        assert len(single_year.econ.leontief_inverse[0]) == single_year.test_derivations.commodity_count
    ...
    def test_total_requirements(self, single_year):
        assert len(single_year.econ.total_requirements) == single_year.test_derivations.commodity_count
    ...
    def test_unit_requirements(self, single_year):
        assert len(single_year.econ.unit_requirements) == single_year.test_derivations.commodity_count
    ...
    def test_unit_price(self, single_year):
        assert len(single_year.econ.unit_price) == single_year.test_derivations.commodity_count
        np.testing.assert_almost_equal(single_year.econ.unit_price,
                                       np.ones(single_year.test_derivations.commodity_count),
                                       decimal=1)

    # modeling derivations

    def test_tax_matrix(self, single_year):
        mock_args = single_year.econ.rel_price_args
        expected = np.zeros((single_year.test_derivations.commodity_count, single_year.test_derivations.industry_count))
    ...
    def test_rel_unit_price(self, single_year):
        ...
        expected = np.ones(single_year.test_derivations.commodity_count)
        assert len(rel_unit_price) == single_year.test_derivations.commodity_count
        np.testing.assert_almost_equal(asserted, expected, decimal=1)

    def test_demand_argument(self, single_year):

        mock_args = single_year.econ.rel_demand_args

        assert len(mock_args) == len(single_year.econ.rel_price_args)
    ...
    def test_rel_total_requirements(self, single_year):
        assert len(single_year.econ.rel_total_requirements) == single_year.test_derivations.commodity_count
    ...
    def test_process_args(self, single_year):
        ...
        vals = [random.random() for j in range(single_year.test_derivations.commodity_count)]
        asserted = single_year.econ.process_args(list(zip(names, vals)))
